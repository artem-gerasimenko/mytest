...
public class SearchTest extends QiwiTest {
   ...
   @Test(description = "Test3. Проверка поиска при вводе спец. символов"
            , suiteName = "Qw")
    ...
    @Test(description = "Test4. Проверка поиска по заданному слову транслитом"
            , suiteName = "Qw")
    ...
    @Test(description = "Test5. Проверка перехода на страницу услуги + поиск ссылки"
            , suiteName = "Qw")
